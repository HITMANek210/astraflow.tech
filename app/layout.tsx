...
const defaultDescription = "Brand Strategist & Security Analyst at ING. Helping executives build personal brands that command attention, open doors, and drive real results.";
